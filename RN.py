...
while round<10:
  ...
  print("  Round:",round)
  print(f"\n    To activate {Player1}'s turn press 1")
  press=int(input("     "))
  if press==1:
    print(f"                   {Player1} score's {ran1}\n")
  else:
    print("Error")  
  print(f"    To activate {Player2}'s turn press 2")
  press=int(input("     "))
  if press==2:
    print(f"                   {Player2} score's {ran2}\n")
    time.sleep(3)
  else:
    print("Error")  
  print(" After Round:",round)
  print(f"    {Player1} score is {P1_score}\n    {Player2} score is {P2_score}\n")
